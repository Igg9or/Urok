...
def init_db():
    ...
    # Создаем таблицу классов (в одном execute)
    cursor.execute('''
    ...
    # Создаем таблицу пользователей (в одном execute)
    cursor.execute('''
    ...
    # Создаем таблицу уроков (в одном execute)
    cursor.execute('''
    ...
    # Создаем таблицу заданий (в одном execute)
    cursor.execute('''
    ...
    # Создаем таблицу предметов (в одном execute)
    cursor.execute('''
    ...
    # Создаем таблицу вариантов заданий (в одном execute)
    cursor.execute('''
    ...
    # Создаем таблицу ответов учеников (в одном execute)
    cursor.execute('''
