    ...
    try:
        ...
        for task in base_tasks:
            ...
            if variant:
                ...
                computed_answer = MathEngine.evaluate_expression(answer_template.format(**params), params)
...
def api_check_answer():
    try:
        ...
        if answer_type == 'algebraic':
            # Сравниваем алгебраические выражения
            user_simplified = MathEngine.evaluate_expression(user_answer, params)
            correct_simplified = MathEngine.evaluate_expression(correct_answer, params)
            is_correct = user_simplified == correct_simplified
        else:
        ...
        return jsonify({
            ...
            "evaluated_answer": user_simplified if answer_type == 'algebraic' else user_val
        })
    except Exception as e:
        print("Error in check_answer:", str(e))
        return jsonify({"error": str(e)}), 500
