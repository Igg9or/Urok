document.addEventListener('DOMContentLoaded', function() {
    ...
    const elements = {
        ...
        answerFormula: document.getElementById('answerFormula'),
        ...
        taskExamples: document.getElementById('taskExamples'),
        saveTaskBtn: document.getElementById('saveTaskBtn'),
        previewTaskBtn: document.getElementById('previewTaskBtn'),
