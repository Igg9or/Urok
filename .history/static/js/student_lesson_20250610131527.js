document.addEventListener('DOMContentLoaded', function() {
    ...
    const errorMessage = incorrectFeedback.querySelector('.error-message');
    ...
    if (isCorrect) {
        ...
        let message = `Ошибка! Правильный ответ: ${taskCard.querySelector('.correct-answer').textContent}`;
        if (evaluatedAnswer) {
            message += ` (Ваш ответ: ${evaluatedAnswer})`;
        }
