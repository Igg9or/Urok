document.addEventListener('DOMContentLoaded', function() {
    ...
    previewQuestion.textContent = "Генерация примера...";
    previewAnswer.textContent = "Генерация ответа...";
    ...
    fetch(`/api/generate_from_template/${templateId}`)
        ...
        .then(data => {
            ...
            previewQuestion.innerHTML = data.question || "Не удалось сгенерировать";
            previewAnswer.textContent = data.correct_answer || "Не удалось сгенерировать";
        ...
        .catch(error => {
            ...
            previewQuestion.textContent = "Ошибка генерации примера";
            previewAnswer.textContent = "Попробуйте позже";
        });
}
