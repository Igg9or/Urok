document.addEventListener('DOMContentLoaded', function() {
    if (!window.LESSON_DATA) {
        console.error('LESSON_DATA not defined');
        alert('Ошибка загрузки данных урока');
        return;
    }

    const API_URL = `${window.LESSON_DATA.apiBaseUrl}/${window.LESSON_DATA.id}/tasks`;
    ...
    function setupEventListeners() {
        ...
        document.getElementById('previewTaskBtn').addEventListener('click', previewTask);
